...
<div class="row justify-content-center ">
    <div class="card col-11">
      @if(Session::has('message'))
			...
			@endif
      <div class="mt-1">
        <h5 class="text-center text-uppercase font-weight-bold">Liste de tout les ajouts</h5>
        <a class="btn btn-warning" href="{{route('dashbord')}}">{{ __('Retour') }}</a>
                ...
                <tr class="tablecolor text-center">
                  ...
                  <td>
                    <a href=""><button class="btn btn-success">Modifier</button></a>
                     <a href=""><button class="btn btn-danger">Supprimer<i class="fas fa-trash"></i></button></a>
                  </td>
                </tr>
                  @endforeach
            </tbody>
